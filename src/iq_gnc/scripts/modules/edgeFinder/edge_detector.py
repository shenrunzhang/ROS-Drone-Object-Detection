...
parser.add_argument('--width', help='Resize input image to a specific width', default=3000, type=int)
parser.add_argument('--height', help='Resize input image to a specific height', default=1500, type=int)
